...
//		demo.readExample();
	...
	public void insertMember(String query) throws SQLException {
	...
	public void readExample(String query){
...
//				LibraryMember libraryMember=new LibraryMember(name, name, name, id, address);
			}
			else {
	...
	void updateExample(String query){
		try {
			stmt = con.createStatement();
